    ...
    <body class="d-flex flex-column h-100">
        <main class="flex-shrink-0">
                ...
                <div class="container px-5">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/board/Login.us">로그인(동준작업중)</a></li>                            
            ...
            <header class="lemon-bg py-5">
                <div class="container px-5">
                    <div name = val class="row gx-5 align-items-center justify-content-center">
              
                        
                        <div class="col-lg-8 col-xl-7 col-xxl-6">
                            <div class="my-5 text-center text-xl-start">
                                <h1 name = "val" class="display-5 fw-bolder text-black mb-2">당신 근처의 지역 생활 커뮤니티</h1>
                                <% %>
                        ...
                        <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5" src="${pageContext.request.contextPath}/picture/lemon1.jpg" alt="..." /></div>
                    </div>
                </div>
            </header>
            <!-- Features section-->
            <section class="py-5" id="features">
                <div class="container px-5 my-5">
                    <div class="row gx-5">
                        <div class="col-lg-4 mb-5 mb-lg-0"><h2 class="fw-bolder mb-0">현재 판매중인 물건들이에요!</h2></div>
                        <div class="col-lg-8">
