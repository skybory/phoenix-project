...
public class BoardFrontController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case "/board/Category.bo":
	        ...
	        // 두 번째 액션 실행: 랜덤 상품 목록 가져오기
	        RandomProductListAction randomProductListAction = new RandomProductListAction();
	        randomProductListAction.execute(req, resp); // 이 액션은 randomProductList를 request 속성에 설정합니다.
