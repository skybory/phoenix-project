...
public class BeautyCategoryAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			// '뷰티' 카테고리의 ID를 정의합니다. 실제 값은 데이터베이스 상의 '의류' 카테고리 ID와 일치 해야함
			String categoryId = "2";
			...
			forward.setPath("/webapp/category/beauty.jsp"); // 상대 경로로 설정
